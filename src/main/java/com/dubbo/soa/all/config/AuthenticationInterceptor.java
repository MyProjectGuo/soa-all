...
import com.dubbo.soa.all.model.HttpHeaderInfo;
...
public class AuthenticationInterceptor implements HandlerInterceptor {
	...
	/**
	 * * 在请求处理之前进行调用（Controller方法调用之前） * * @param request * @param response * @param
	 * handler * @return * @throws Exception
	 */
	@Override
	...
	/**
	 * * 请求处理之后进行调用，但是在视图被渲染之前（Controller方法调用之后） * * @param httpServletRequest *
	 * 
	 * @param httpServletResponse
	 *            *
	 * @param o
	 *            * @param modelAndView * @throws Exception
	 * */
	@Override
	 ...
	 *            * @param httpServletResponse * @param o * @param e * @throws
	 *            Exception
	 */
	@Override
